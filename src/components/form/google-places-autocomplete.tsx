import { GoogleMap, LoadScript, LoadScriptNext, Autocomplete, useJsApiLoader } from "@react-google-maps/api";
...
export default function GooglePlacesAutocomplete({ onChange, data, }: { onChange: any;data: LocationInput; }) {
